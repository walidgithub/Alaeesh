...
class MyActivitiesCommentView extends StatefulWidget {
  final String id;
  ...
  @override
  State<MyActivitiesCommentView> createState() => _MyActivitiesCommentViewState();
}

class _MyActivitiesCommentViewState extends State<MyActivitiesCommentView> {
