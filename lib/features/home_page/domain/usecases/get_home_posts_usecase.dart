...
class GetHomePostsUseCase extends FirebaseBaseUseCase{
  final HomePageRepository homePageRepository;

  GetHomePostsUseCase(this.homePageRepository);

  @override
  Future<Either<FirebaseFailure, List<HomePageModel>>> call(parameters) async {
    return await homePageRepository.getHomePosts(parameters);
  }
}