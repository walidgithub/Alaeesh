...
class FirebaseErrorHandler {
  ...
  String handleFirebaseError(dynamic e) {
    String errorMessage = 'An unknown error occurred';
  ...
  //     await someFirebaseMethod();
  //   } on FirebaseAuthException catch (e) {
  //     FirebaseErrorHandler.handleAuthError(context, e);
  //   } on FirebaseException catch (e) {
  //     FirebaseErrorHandler.handleFirebaseError(context, e);
  //   } catch (e) {
  //     FirebaseErrorHandler.handleGenericError(context, e);
  //   }
  // }
}
